...
const binName = isWindows ? 'canopy.exe' : 'canopy'
...
console.log(`${color.cyan}[build:cli]${color.reset} 编译 canopy CLI → ${color.dim}${outFile}${color.reset}`)
