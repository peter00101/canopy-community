...
// Canopy macOS Agent Island native host.
...
struct NotchMetrics {
  ...
  init(screen: NSScreen) {
    if #available(macOS 12.0, *),
      ...
      // space needed by Canopy's compact status and quota badge on small Macs.
...
struct ExpandedIslandView: View {
  ...
  private var headerEyebrow: String {
    switch primaryPhase {
    case "needs-interaction": return "CANOPY · HANDOFF"
    case .some: return "CANOPY · AGENT"
    case .none: return "CANOPY · REMINDER"
    }
  }
