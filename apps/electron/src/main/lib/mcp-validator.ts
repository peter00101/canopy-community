...
import { normalizeMcpTransportType } from '@canopy/shared'
import type { McpServerEntry } from '@canopy/shared'
...
export async function validateMcpServer(
  ...
  const client = new Client({ name: `${CANOPY_BRAND.productName} MCP validator`, version: '1.0.0' }, { capabilities: {} })
