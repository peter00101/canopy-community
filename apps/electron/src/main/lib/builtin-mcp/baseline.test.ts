...
test('Given Canopy runtime tools When listing configurable integrated MCP capabilities Then only Nano Banana is exposed while runtime names stay reserved', () => {
