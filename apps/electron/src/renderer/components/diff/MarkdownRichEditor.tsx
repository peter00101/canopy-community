    ...
    <div className={cn('flex flex-col', editing ? 'h-full' : 'min-h-full')}>
      ...
      <EditorContent
        ...
        className={cn(
          ...
          showMermaidPreview
            ? [
                '[&_.canopy-code-block--mermaid]:overflow-visible',
                '[&_.canopy-code-block--mermaid]:rounded-none',
                '[&_.canopy-code-block--mermaid]:border-0',
                '[&_.canopy-code-block--mermaid]:bg-transparent',
                '[&_.canopy-code-block--mermaid_.canopy-code-header]:hidden',
                '[&_.canopy-code-block--mermaid_.canopy-mermaid-preview]:block',
                '[&_.canopy-code-block--mermaid_.canopy-code-source-body]:hidden',
              ]
            : '[&_.canopy-mermaid-preview]:hidden [&_.canopy-code-source-body]:block',
        )}
      />
