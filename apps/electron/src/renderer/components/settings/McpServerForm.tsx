...
import type { McpOAuthConfiguration, McpServerEntry, McpTransportType, WorkspaceMcpConfig } from '@canopy/shared'
import {
  SettingsSection,
  SettingsCard,
  SettingsInput,
      ...
      <SettingsSection title="基本信息">
        <SettingsCard>
          ...
          <div className="px-4 py-3 space-y-3 border-t border-border">
            ...
            {/* 未测试警告 */}
            {!testResult && !testing && (
              <div className="flex items-start gap-2 px-3 py-2 rounded-md text-sm bg-warning-soft text-warning dark:text-warning">
