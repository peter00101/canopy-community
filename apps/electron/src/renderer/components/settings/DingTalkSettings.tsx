...
import type { DingTalkBotConfig, DingTalkBotBridgeState, DingTalkBridgeStatus, DingTalkTestResult } from '@canopy/shared'
        ...
        <SettingsCard divided={false}>
          <div className="px-4 py-4 space-y-5 text-sm">
            ...
            <div className="space-y-1.5">
              ...
              <p className="pl-7 text-muted-foreground">
                在「应用能力」中启用机器人功能。
                然后回到 {CANOPY_BRAND.productName}，<span className="text-foreground font-medium">先点击「保存配置」</span>，
            ...
            <div className="pl-7 p-3 rounded-lg bg-warning-soft text-warning dark:text-warning text-xs">
              <span className="font-medium">重要：</span>配置事件订阅前，必须先在 {CANOPY_BRAND.productName} 中保存凭证并确认 Stream 连接成功，
