    ...
    >
      <SettingsCard divided={false}>
        <div className="space-y-4 p-4">
          ...
          {testResult && (
            <div className={`flex items-start gap-2 rounded-lg p-3 text-sm ${testResult.success ? 'bg-success-soft text-success dark:text-success' : 'bg-destructive/10 text-destructive'}`}>
