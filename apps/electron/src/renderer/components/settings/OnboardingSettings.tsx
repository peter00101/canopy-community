...
export function OnboardingSettings(): React.ReactElement {
  ...
  return (
    <div className="space-y-6">
      <SettingsSection
        title={`${CANOPY_BRAND.productName} 新手引导`}
        description={`重新了解 ${CANOPY_BRAND.productName} 的核心工作方式`}
      >
        <SettingsCard>
          <div className="flex items-start gap-4 px-4 py-5">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-sm font-medium text-foreground">准备好重新认识 {CANOPY_BRAND.productName} 了吗？</h2>
