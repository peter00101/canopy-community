  ...
  switch (status) {
    case 'in_progress':
      return {
        ...
        className: 'border-info/20 bg-info-soft text-info dark:text-info',
        icon: Clock3,
      }
    case 'completed':
      return {
        label: getTaskGetStatusLabel(status),
        className: 'border-success/20 bg-success-soft text-success dark:text-success',
        icon: CheckCircle2,
      }
    case 'blocked':
      return {
        label: getTaskGetStatusLabel(status),
        className: 'border-warning/25 bg-warning-soft text-warning dark:text-warning',
        icon: Circle,
      }
    case 'cancelled':
    case 'error':
