...
import type { Automation } from '@canopy/shared'
                ...
                <button
                  ...
                  className={cn(
                    ...
                    a.active
                      ...
                      : 'text-foreground/30 hover:bg-success-soft hover:text-success group-hover:text-foreground/45',
                  )}
                >
    ...
    <div className="max-w-2xl mx-auto pt-24 flex flex-col items-center text-center gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="text-[13px] text-foreground/50 leading-relaxed max-w-md">
          ...
          也可以在对话中用「以后每隔 X 分钟…」让 {CANOPY_BRAND.productName} 自动识别并创建。
        </div>
      </div>
      <button
        type="button"
