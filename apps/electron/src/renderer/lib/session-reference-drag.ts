...
export const SESSION_REFERENCE_DRAG_MIME = 'application/x-canopy-session-reference'
 ...
 */
export const INSERT_SESSION_REFERENCE_MENTION_EVENT = 'canopy:insert-session-reference-mention'
