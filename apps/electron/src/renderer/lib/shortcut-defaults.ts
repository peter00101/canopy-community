...
export const DEFAULT_SHORTCUTS: ShortcutDefinition[] = [
  ...
  // 由 Electron 原生菜单角色处理，展示但不允许在应用内修改。
  {
    id: 'zoom-in',
    name: '放大界面',
    description: `提高 ${CANOPY_BRAND.productName} 界面的缩放比例`,
    defaultMac: 'Cmd+Plus',
  ...
  },
  {
    id: 'zoom-out',
    name: '缩小界面',
    description: `降低 ${CANOPY_BRAND.productName} 界面的缩放比例`,
  ...
  },
  {
    id: 'reset-zoom',
    name: '重置界面缩放',
    description: `恢复 ${CANOPY_BRAND.productName} 界面的默认缩放比例`,
    defaultMac: 'Cmd+0',
    defaultWin: 'Ctrl+0',
    category: 'app',
    readonly: true,
  ...
  },
  {
    id: 'show-main-window',
    name: '显示主窗口',
    description: `显示并聚焦 ${CANOPY_BRAND.productName} 主窗口`,
