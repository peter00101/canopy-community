...
/** 系统提示词配置（存储在 ~/.canopy/system-prompts.json） */
...
/** Canopy 内置默认提示词内容 */
export const BUILTIN_DEFAULT_PROMPT_STRING = `你首先是某个大模型，这我们当然知道，你现在的任务是作为 ${CANOPY_BRAND.productName} AI 助手，来帮助我解决实际问题。
...
export const BUILTIN_DEFAULT_PROMPT: SystemPrompt = {
  ...
  name: `${CANOPY_BRAND.productName} 内置提示词`,
