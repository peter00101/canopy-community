...
import type { WeChatConfig, WeChatCredentials } from '@canopy/shared'
...
export function getWeChatConfig(): WeChatConfig {
  const configPath = requireImBridgeBusinessDeps().paths.getWeChatConfigPath()
